...
The tag controller in Mocha is imported from Capabilities Limited.
The documentation for the hardware IP block is provided as part of the upstream repository under [/docs/tag_controller.adoc](https://github.com/Capabilities-Limited/axi_cheri_tagcontroller/blob/main/docs/tag_controller.adoc).
...
|---------------|----------------------------|--------|------------------|
| Documentation | SPEC_COMPLETED             | Done   | The documentation and specifications of the tag controller is available in the tag controller repository under [`/docs/tag_controller.adoc`](https://github.com/Capabilities-Limited/axi_cheri_tagcontroller/blob/main/docs/tag_controller.adoc). It mentions the overall expected behaviour of the tag controller and describes a more recent [HPDCache](https://github.com/Capabilities-Limited/cv-hpdcache)-based version with support for advanced configuration and hierarchical tag table.
| Documentation | CSR_DEFINED                | Done   | The documentation has a [Programmer’s Model & Software Interface](https://github.com/Capabilities-Limited/axi_cheri_tagcontroller/blob/main/docs/tag_controller.adoc#5-programmers-model--software-interface) section describing the memory mapped configuration interface of the recent tag controller.
...
| RTL           | IP_INSTANTIABLE            | Done   | The tag controller's toplevel module is instantiated in [`/hw/top_chip/rtl/top_chip_system.sv`](/hw/top_chip/rtl/top_chip_system.sv#L1288-L1319).
